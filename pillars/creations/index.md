...
">
  ...
  <h1 style="margin:0; font-family:'Space Grotesk','Quicksand',system-ui,sans-serif;">Creations</h1>
  <p style="margin:10px 0 0; line-height:1.55;">
    A small gallery of things I’ve made—starting with ceramics.
  </p>

  <hr style="margin:18px 0;border:none;border-top:1px solid rgba(40,40,80,.14);">

  <h2 style="margin:0 0 10px; font-family:'Space Grotesk','Quicksand',system-ui,sans-serif;">Ceramics</h2>
